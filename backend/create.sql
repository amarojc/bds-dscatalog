    ...
    alter table tb_user_role 
       ...
       foreign key (user_id) 
       references tb_user;
INSERT INTO tb_user (first_name, last_name, email, password, created_At) VALUES ('Alex', 'Brown', 'alex@gmail.com', '$2a$10$eACCYoNOHEqXve8aIWT8Nu3PkMXWBaOxJ9aORUYzfMQCbVBIhZ8tG', TIMESTAMP WITH TIME ZONE '2023-05-30T18:17:07.12345Z');
INSERT INTO tb_user (first_name, last_name, email, password, created_At) VALUES ('Maria', 'Green', 'maria@gmail.com', '$2a$10$eACCYoNOHEqXve8aIWT8Nu3PkMXWBaOxJ9aORUYzfMQCbVBIhZ8tG', TIMESTAMP WITH TIME ZONE '2023-05-30T18:17:07.12345Z');
